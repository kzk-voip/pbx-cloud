...
import TenantCallRoutes from '../Tenants/TenantCallRoutes'
...
export default function Routes() {
  ...
  return (
    <>
      ...
      {tenantId ? (
        <TenantCallRoutes tenantId={tenantId} />
      ) : (
        <p className={s.empty}>
          {isSuperAdmin ? 'Please select a tenant to manage outbound call routes.' : 'No tenant association found.'}
        </p>
      )}
    </>
  )
