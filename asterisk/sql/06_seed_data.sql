...
VALUES
    ('t1_101', 'transport-udp', 't1_101', 't1_101', 'from-kamailio', 'all', 'ulaw',
     FALSE, TRUE, TRUE, TRUE, '"Acme 101" <101>', 1),
    ('t1_102', 'transport-udp', 't1_102', 't1_102', 'from-kamailio', 'all', 'ulaw',
...
INSERT INTO ps_endpoints (id, transport, aors, auth, context, disallow, allow,
    direct_media, force_rport, rewrite_contact, rtp_symmetric, callerid, tenant_id)
VALUES
    ('t2_101', 'transport-udp', 't2_101', 't2_101', 'from-kamailio', 'all', 'ulaw',
     FALSE, TRUE, TRUE, TRUE, '"Globex 101" <101>', 2),
    ('t2_102', 'transport-udp', 't2_102', 't2_102', 'from-kamailio', 'all', 'ulaw',
